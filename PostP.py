...
N=len(test0['LLRF44:CH5_:IWF'])
for i in range(N):
    plt.plot(test0['LLRF44:CH5_:IWF'][i])
plt.show()

for i in range(N):
    plt.plot(test0['LLRF44:CH5_:QWF'][i])
plt.show()


for i in range(N):
    plt.plot(test0['LLRF44:CH5_:PWF'][i])
plt.show()

for i in range(N):
    plt.plot(test0['LLRF44:CH5_:IWF'][i][400:800])
plt.show()

for i in range(N):
    plt.plot(test0['LLRF44:CH5_:QWF'][i][400:800])
plt.show()
